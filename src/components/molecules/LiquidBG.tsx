...
const defaultColors = ['#29b8ff', '#9eb1ff', '#a3ddf0'];
...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update(args?: Partial<{ dt: number; isBounce: boolean; BFECC: boolean }>) {
    ...
    class ExternalForce extends ShaderPass {
      mouse!: THREE.Mesh;
      private simProps: SimulationProps;
      constructor(simProps: SimulationProps) {
      ...
      update(args?: Partial<{ mouse_force: number; cellScale: { x: number; y: number }; cursor_size: number }>) {
        const props = args || {};
    ...
    class Viscous extends ShaderPass {
      ...
      update(args?: Partial<{ viscous: number; iterations: number; dt: number }>) {
        const { viscous, iterations, dt } = args || {};
        if (!this.uniforms) return;
        let fbo_in: THREE.WebGLRenderTarget | undefined, fbo_out: THREE.WebGLRenderTarget | undefined;
        ...
        // If no iterations, return output0 by default
        return fbo_out ?? this.props.output0;
      }
    }
    ...
    class Divergence extends ShaderPass {
      ...
      update(args?: Partial<{ vel?: THREE.WebGLRenderTarget }>) {
        const { vel } = args || {};
    ...
    class Poisson extends ShaderPass {
      ...
      update(args?: Partial<{ iterations?: number }>) {
        let p_in: THREE.WebGLRenderTarget | undefined;
        let p_out: THREE.WebGLRenderTarget | undefined = this.props.output0;
    ...
    class Pressure extends ShaderPass {
      ...
      update(args?: Partial<{ vel?: THREE.WebGLRenderTarget; pressure?: THREE.WebGLRenderTarget }>) {
